...
public class SpdyUtil {
    ...
    public static final int MASK_VERSION_HEADER = 0x7FFF;
    public static final int MASK_TYPE_HEADER = 0xFFFF;
    ...
    public static final byte[] SPDY_dictionary_txt = new byte[]{
